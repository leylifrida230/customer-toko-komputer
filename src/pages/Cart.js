...
export default class Cart extends React.Component{
    constructor(){
        ...
        this.state = {
            ...
            total: 0, // untuk menyimpn data total belanja
        }
    ...
    initCart = () => {
        // memanggil data pada cart localStorage
        let tempCart = []
        ...
        // memasukkan data cart, use, dan total harga pada state
        this.setState({
            cart: tempCart,
            total: totalHarga
        })
    ...
    dropItem = selectedItem => {
        if (window.confirm(`apakah anda yakin akan menghapus ${selectedItem.name} dari cart?`)) {
            let tempCart = []
            if (localStorage.getItem("cart") !== null){
                tempCart = JSON.parse(localStorage.getItem("cart"))
            }
